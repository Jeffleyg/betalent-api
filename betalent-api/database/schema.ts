...
export class TransactionProductSchema extends BaseModel {
  static $columns = ['amount', 'createdAt', 'id', 'name', 'productId', 'quantity', 'transactionId', 'updatedAt'] as const
...
export class TransactionSchema extends BaseModel {
  static $columns = ['cardLastNumbers', 'clientId', 'createdAt', 'externalId', 'gatewayId', 'id', 'productId', 'quantity', 'status', 'totalAmount', 'updatedAt'] as const
